 ...
 *
 * The official implementation, unchanged: a second copy of the children scaled
 * about the pointer and revealed through a radial mask that follows it.
 *
 * Used on exactly one gallery plate, and only where there is a real pointer to
 * drive it — see `usePointerFine`. It deliberately sits outside the mosaic rows:
 * the lens renders its children twice, and the mosaic's tile mechanics count on
 * finding exactly nine masks inside a cell.
 */
