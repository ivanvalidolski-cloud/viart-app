 ...
 *
 * It is only allowed on a display heading that no MotionPrompts scene and no
 * `data-reveal="mask"` already owns — two animation systems on one headline is
 * how you get a line that fades in twice, or never.
 */
